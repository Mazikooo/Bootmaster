                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Tambah Template Bootsrap</h5>
                                            ...
                                            <div class="col-md-7">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-material" method="post" name="sentmessage" action="<?php echo site_url('templateadmin/aksi_simpan'); ?>" enctype="multipart/form-data">
