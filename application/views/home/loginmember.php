            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form action="<?php echo site_url('main/login_member');?>" class="md-float-material form-material" method="post">
                                    ...
                                    <div class="row m-t-25 text-left">
                                        <div class="col-12">
                                            ...
                                            <div class="forgot-phone text-right f-right">
                                                <a href="<?php echo site_url('main/register');?>" class="text-right f-w-600">Register Member</a>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="forgot-phone text-right f-right">
                                                <a href="<?php echo site_url('loginadmin');?>" class="text-right f-w-600">Admin Panel</a>
