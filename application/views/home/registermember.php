...
<head>
    <title>Member Register Bootmaster </title>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <?php echo $this->session->flashdata('not'); ?>
                        <form action="<?php echo site_url('main/save');?>" class="md-float-material form-material" method="post">
                            <div class="text-center">
                                <img src="<?php echo base_url('assets/admin/images/logobm2.png')?>" width="130" height="30" alt="logo.png">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <h3 class="text-center">Register Member</h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Register Now</button>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <img src="<?php echo base_url('assets/admin/images/logobm2.png')?>" width="90" height="20" alt="small-logo.png">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/admin/js/common-pages.js')?>assets"></script>
</body>
